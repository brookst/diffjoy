 ...
 */
#define USB_CFG_VENDOR_NAME     'S','k','o','o','r','b'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'D','i','f','f','j','o','y'
 ...
 * protocol.
 */
#define USB_CFG_HID_REPORT_DESCRIPTOR_LENGTH     31 /* total length of report descriptor */
